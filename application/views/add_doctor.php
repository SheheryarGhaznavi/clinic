							...
							<!-- Advanced legend -->
								...
								<div class="panel panel-flat">
									<div class="panel-heading">
										<h5 class="panel-title">Add Doctor Form</h5>
                      ...
                      <optgroup label="Select a Blood Gruop">
                        ...
                        <?php foreach($gen as $c): ?>
                                               ...
                                               <?php endforeach ?>
					                			...
					                			<div class="form-group">
													<label style="font-weight:bold;">About Doctor:</label>
...
<div class="container">
 ...
 -->
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form class="dropzone" action="<?php echo site_url('/doctor/u')?>" ></form>
...
var fileCount;
  ...
  $('.selectImage').on('click',function(e){
    ...
    var url = '<?php echo site_url("doctor/add_doctor")?>';
    ...
    imgUpdate = new Dropzone(".selectImage",
    {
      ...
      success: function(file, response){
          var data = $.parseJSON(response);
                          if (data['success']) {
                          $('.alertdiv').html('<div class="alert alert-success alert-styled-left alert-arrow-left alert-bordered"><button type="button" class="close" data-dismiss="alert"><span>&times;</span><span class="sr-only">Close</span></button><span class="text-semibold">Successfull!</span> doctor Entered.</div>');
                           window.setTimeout(function(){window.location.replace("<?php echo site_url('doctor') ?>");},1000) 
...
//    doctorData.name = $('#name').val();
//     doctorData.email = $('#email').val();
//     doctorData.password = $('#password').val();
//     doctorData.dept_id = $('#dept_id').val();
//     doctorData.dob = $('#dob').val();
//     doctorData.gender = $('#gender').val();
//     doctorData.phone_no = $('#phone_no').val();
//     doctorData.address = $('#address').val();
//     doctorData.image = $('#image').val();
//     doctorData.description = $('#description').val();	
 //     doctorData.created_on = $('#created_on').val();
 // if(!$('#name').val()){
 //     	new PNotify({
 //     		title:'Error',
 //     		text:'Fill the Name fields',
